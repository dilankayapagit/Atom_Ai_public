...
class CategoryTranslationModel {
  ...
  factory CategoryTranslationModel.fromJson(String source) => CategoryTranslationModel.fromMap(json.decode(source) as Map<String, dynamic>);

  @override
  String toString() {
    return 'CategoryTranslationModel(en: $en, fr: $fr, es: $es, de: $de, it: $it, zh: $zh, ja: $ja)';
  }

  @override
  bool operator ==(covariant CategoryTranslationModel other) {
